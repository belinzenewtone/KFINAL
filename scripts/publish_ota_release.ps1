...
#   - keystore.properties present in repo root
...
# --- 4. Rename APK and create GitHub Release --------------------------------
$apkDst = Join-Path (Split-Path $apkSrc) $ApkName
...
gh release create $TagName $apkDst `
