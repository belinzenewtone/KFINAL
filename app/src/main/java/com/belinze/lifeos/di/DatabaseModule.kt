...
object DatabaseModule {
    ...
    fun provideDatabase(@ApplicationContext context: Context): LifeOsDatabase {
        ...
        return Room.databaseBuilder(
            ...
            // Take ownership of an existing database created by expo-sqlite (user_version = 0)
            .addMigrations(LifeOsDatabase.MIGRATION_0_1)
            // Fallback only on downgrade (safety net; should never fire in practice)
